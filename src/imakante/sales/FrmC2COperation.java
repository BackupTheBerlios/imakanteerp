...
public class FrmC2COperation extends  imakante.com.vcomponents.iInternalFrame implements java.awt.event.WindowListener {
    
    public FrmC2COperation(String title, imakante.com.vcomponents.iFrame frame, int level, int ndtur) {
        super(title);
        myframe = frame;
        this.level = level;
        this.ndtur = ndtur;
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("\u041e\u0440\u0434\u0435\u0440\u0438 \u0437\u0430 \u043c\u0435\u0436\u0434\u0443\u043a\u0430\u0441\u043e\u0432\u0438 \u043f\u0440\u0435\u0445\u0432\u044a\u0440\u043b\u044f\u043d\u0438\u044f");
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .add(org.jdesktop.layout.GroupLayout.TRAILING, jPanel4Layout.createSequentialGroup()
                ...
                .add(jPanel4Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(jtfContragentEND, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 81, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                    .add(jtfContragentBEGIN, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 81, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                    .add(jLabel3, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 95, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                .add(50, 50, 50)
                .add(jPanel4Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(jXDatePickerEND, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 159, Short.MAX_VALUE)
                    .add(jLabel1, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 159, Short.MAX_VALUE)
                    .add(jXDatePickerBEGIN, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 159, Short.MAX_VALUE))
                .add(59, 59, 59)
                .add(jButtonSearch)
                .add(84, 84, 84))
        );

        jPanel4Layout.linkSize(new java.awt.Component[] {jLabel3, jtfContragentBEGIN, jtfContragentEND}, org.jdesktop.layout.GroupLayout.HORIZONTAL);
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .add(org.jdesktop.layout.GroupLayout.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(jPanel4, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 98, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
        );
    ...
    private int code = 0;
    private int contragent_cod = 0;  // kod na 2-ra kasa
    private String contragent_name = ""; // name na 2-ra kasa
    private int in_in_sl_mop = 1; //id na osnowna kasa
    private int in_code_casa = 1; // cod na osnowna kasa
    private int in_outsl_mop = 0; // id na 2-ra Kasa
    ...
    private  imakante.sales.casa2casaOp internalObject;
    ...
    private imakante.sales.aeC2COp ae_Casa;
    ...
    private String strOtherCRs = "SELECT "
    ...
    private void constructObject() {
        ...
        try {
            internalObject = new imakante.sales.casa2casaOp(conn, this.level, this.sdtn);
        } catch(Exception e) { e.printStackTrace(); }
    }
    ...
    private void initTable() {
        try {
            ...
            HideColumns(getColumnIndex("id_casa2"));
    ...
    private void processField2() {
        if (this.jtfCasaBegin.getText().equals("")) { this.jtfCasaBegin.setText("0"); }
...
//    }
    ...
    private void processField3() {
        String newString = strCasa + this.jtfContragentBEGIN.getText() + "%'";
    ...
    public void intContrDialog(int CodDialod) {
        String newString = strCasa + this.jtfContragentEND.getText() + "%' AND n_casa.code_n_casa >= " + CodDialod + ";";
    ...
    public void getCodFromQu(int CodDialog) {
        ...
        if (getHInt() == 0 || getHCode() == 0) {
            javax.swing.JOptionPane.showMessageDialog(null, "\u041d\u044f\u043c\u0430 \u043a\u0430\u0441\u0430 \u0441 \u0442\u0430\u043a\u044a\u0432 \u043a\u043e\u0434!",
                    "\u0418\u041c\u0410\u041a\u0410\u041d\u0422\u0415", javax.swing.JOptionPane.ERROR_MESSAGE);
        }
    }
    
    public imakante.sales.casa2casaOp getInternalObject() {
        return internalObject;
    }
    
    public void setInternalObject(imakante.sales.casa2casaOp val) {
    ...
    private void newRecord() {
        ...
        setAtBegining(false);
        setAtEnd(true);
        ae_Casa = new imakante.sales.aeC2COp(this, false);
