...
// Receipt Book Allocation - Razpredelqne na ko4ani mejdu tyrgowskite predstawiteli
public class FrmRBAlloc extends  imakante.com.vcomponents.iInternalFrame implements java.awt.event.WindowListener {
    
    public FrmRBAlloc(String title,imakante.com.vcomponents.iFrame frame) {
        super(title);
        myframe = frame;
