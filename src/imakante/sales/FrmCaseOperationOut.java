    ...
    private void initComponents() {
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .add(jPanel4Layout.createSequentialGroup()
                ...
                .add(jPanel4Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(jtfCasaEND, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 84, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                    .add(jLabel2, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 79, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                    .add(jtfCasaBegin, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 79, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                .add(49, 49, 49)
                .add(jPanel4Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(jPanel4Layout.createSequentialGroup()
                    ...
                    .add(jPanel4Layout.createSequentialGroup()
                        .add(jPanel4Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING, false)
                            ...
                            .add(jtfContragentEND, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 80, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(jPanel4Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                            .add(jPanel4Layout.createSequentialGroup()
                                .add(34, 34, 34)
                            ...
                            .add(jPanel4Layout.createSequentialGroup()
                                ...
                                .add(jPanel4Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                                    ...
                                    .add(jXDatePickerBEGIN, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 128, Short.MAX_VALUE))))
                        .add(17, 17, 17)
                        .add(jButtonSearch)
                        .add(124, 124, 124))))
        );
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .add(org.jdesktop.layout.GroupLayout.TRAILING, jPanel4, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 878, Short.MAX_VALUE)
...
// TODO add your handling code here:
    ...
    private int in_in_sl_mop = 1; //id na kontragenta
    private int in_code_casa = 1; // cod na kasa
    private int in_outsl_mop = 0; // id na kasata
    ...
    private  imakante.sales.caseOpOut internalObject;
    ...
    private imakante.sales.aeCaseOpOut ae_CasaOut;
    ...
    private void constructDialod(String str, int rCompNumber, String[] names){
        ...
        imakante.com.vcomponents.tableDialog td = new imakante.com.vcomponents.tableDialog(this, true, table1, "", "","cod");
        td.setVisible(true);
    ...
    private void constructObject() {
        ...
        try {
            internalObject = new imakante.sales.caseOpOut(conn, this.level, this.sdtn);
        } catch(Exception e) { e.printStackTrace(); }
    }
...
//    }
    ...
    public imakante.sales.caseOpOut getInternalObject() {
        return internalObject;
    }
    
    public void setInternalObject(imakante.sales.caseOpOut val) {
    ...
    private void newRecord() {
        ...
        setAtBegining(false);
        setAtEnd(true);
        ae_CasaOut = new imakante.sales.aeCaseOpOut(this, false);
        ae_CasaOut.setVisible(true);
        refreshTable();
        setButtonEnabled();
    }
