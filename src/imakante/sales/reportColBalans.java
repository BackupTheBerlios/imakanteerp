...
public class reportColBalans extends imakante.com.vcomponents.iInternalFrame implements java.awt.event.WindowListener {
    
    public reportColBalans(String title,imakante.com.vcomponents.iFrame frame, int levelx) {
        super(title);
        myframe = frame;
        this.levelx = levelx;
        ...
        prepareStm();
        initComponents();
        this.jLabel9.setText(""+this.levelx);
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("\u041a\u043e\u043b\u0438\u0447\u0435\u0441\u0442\u0432\u0435\u043d \u0431\u0430\u043b\u0430\u043d\u0441 \u043d\u0430 \u0441\u043a\u043b\u0430\u0434\u043e\u0432\u0435");
        ...
        jPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder("\u041f\u0435\u0440\u0438\u043e\u0434 \u043d\u0430 \u0441\u043f\u0440\u0430\u0432\u043a\u0430"));
        ...
        setBounds((screenSize.width-533)/2, (screenSize.height-290)/2, 533, 290);
