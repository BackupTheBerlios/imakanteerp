...
public class salesFrmConnection extends JDialog implements ActionListener {
    
    private imakante.sales.sales_main main = null;
    ...
    public salesFrmConnection(imakante.sales.sales_main n) {
        super();
        try {
            main = n;
            i = 0;
