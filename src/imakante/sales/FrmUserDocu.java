...
public class FrmUserDocu extends  imakante.com.vcomponents.iInternalFrame implements java.awt.event.WindowListener {
    
    public FrmUserDocu(String title,imakante.com.vcomponents.iFrame frame) {
        super(title);
        myframe = frame;
