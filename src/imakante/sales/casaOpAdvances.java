...
public class casaOpAdvances  extends imakante.com.dbObject {
    //-------------START MyVariables
...
//              IN in_comment_sl_mop VARCHAR(250)) comment
    ...
    private int ContragentBegin = 0;    // otnasq se za MOL
    private int ContragentEnd = 0;      // otnasq se za MOL
    ...
    protected void registerParameters() //OK
    {
        try {
            ...
            getCstm().setInt("in_personBegin", ContragentBegin);
            getCstm().setInt("in_personEnd", ContragentEnd);
