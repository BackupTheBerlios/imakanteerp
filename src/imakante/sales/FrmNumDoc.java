...
public class FrmNumDoc extends  imakante.com.vcomponents.iInternalFrame implements java.awt.event.WindowListener {
    
    public FrmNumDoc(String title,imakante.com.vcomponents.iFrame frame) {
        super(title);
        myframe = frame;
