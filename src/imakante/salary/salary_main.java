...
//
        ...
        javax.swing.JMenuItem ItmHelp= new javax.swing.JMenuItem("�� ����������");
        ...
        javax.swing.JMenuItem ItmDocum= new javax.swing.JMenuItem("������������");
        ...
        javax.swing.JMenuItem ItmUpdate= new javax.swing.JMenuItem("����������");
...
//End records menu
    ...
    protected javax.swing.JToolBar CreateJToolBar(){
        ...
        NewJToolBar.add(CreateJToolbarButton("�������� ���������","c:/imakante/ico_sluj.png","sluj"));
