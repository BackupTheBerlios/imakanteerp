...
public class FrmTransferi extends  imakante.com.vcomponents.iInternalFrame implements java.awt.event.WindowListener {
    
    public FrmTransferi(String title,imakante.com.vcomponents.iFrame frame) {
        super(title);
        myframe = frame;
