...
// TODO add your handling code here:
    ...
    public static void initNames(String strIniTable){
        ...
        try{
            ...
            if(Integer.parseInt((String.valueOf(strIniTable.charAt(6))))==1){ Names[x] = "\u0414\u0430\u0442\u0430 \u043d\u0430 \u0440\u0430\u0436\u0434\u0430\u043d\u0435"; strQ=strQ + ", DATE_FORMAT(ls_dates.b_date,'%Y-%m-%d') AS bdate";x++;}
            ...
            if(Integer.parseInt((String.valueOf(strIniTable.charAt(9)))) == 1){Names[x] ="\u0418\u0437\u0434\u0430\u0434\u0435\u043d\u0430 \u043d\u0430"; strQ=strQ + ", DATE_FORMAT(ls_dates.data_izd_LK,'%Y-%m-%d') AS date_lk";x++;}
            ...
            if(Integer.parseInt((String.valueOf(strIniTable.charAt(18))))==1){ Names[x] = "\u0414\u0430\u0442\u0430 \u043d\u0430 \u043d\u0430\u0437\u043d\u0430\u0447\u0430\u0432\u0430\u043d\u0435"; strQ=strQ + ", DATE_FORMAT(ls_dates.data_naznach,'%Y-%m-%d') AS nazdate";x++;}
            if(Integer.parseInt((String.valueOf(strIniTable.charAt(19))))==1){ Names[x] = "\u0414\u0430\u0442\u0430 \u043d\u0430 \u043f\u043e\u0441\u0442\u044a\u043f\u0432\u0430\u043d\u0435"; strQ=strQ + ", DATE_FORMAT(ls_dates.data_postypwane,'%Y-%m-%d') AS postdate";x++;}
            if(Integer.parseInt((String.valueOf(strIniTable.charAt(20))))==1){ Names[x] = "\u0414\u0430\u0442\u0430 \u043d\u0430 \u043d\u0430\u043f\u0443\u0441\u043a\u0430\u043d\u0435"; strQ=strQ + ", DATE_FORMAT(ls_dates.data_napuskane,'%Y-%m-%d') AS napudate";x++;}
            if(Integer.parseInt((String.valueOf(strIniTable.charAt(21))))==1){ Names[x] = "\u041f\u043e\u0441\u043b\u0435\u0434\u0435\u043d \u0434\u0435\u043d \u0432 \u043e\u0441\u0438\u0433\u0443\u0440\u044f\u0432\u0430\u043d\u0435"; strQ=strQ + ", DATE_FORMAT(ls_dates.posl_den_w_osig,'%Y-%m-%d') AS posddate";x++;}
            if(Integer.parseInt((String.valueOf(strIniTable.charAt(22))))==1){ Names[x] = "\u041e\u0441\u043d\u043e\u0432\u0430\u043d\u0438\u0435 \u043d\u0430 \u0434\u043e\u0433\u043e\u0432\u043e\u0440\u0430"; strQ=strQ + ", osnowanie_dog";x++;}
            if(Integer.parseInt((String.valueOf(strIniTable.charAt(23))))==1){ Names[x] = "\u0421\u0440\u043e\u043a \u043d\u0430 \u0414\u043e\u0433\u043e\u0432\u043e\u0440\u0430"; strQ=strQ + ", DATE_FORMAT(ls_dates.srok_dogov, '%Y-%m-%d') AS srok_dog ";x++;}
