...
// TODO add your handling code here:
    ...
    public static void initNames(String strIniTable){
        ...
        int x =0;
        try{
            if(Integer.parseInt((String.valueOf(strIniTable.charAt(0))))==1){ Names[x] = "\u0412\u044a\u0442\u0440\u0435\u0448\u0435\u043d \u043d\u043e\u043c\u0435\u0440"; strQ=strQ + "ls_main.id"; x++;}
            if(Integer.parseInt((String.valueOf(strIniTable.charAt(1))))==1){ Names[x] = "\u041d\u043e\u043c\u0435\u0440"; strQ=strQ + ", ls_main.nomer";x++;}
            if(Integer.parseInt((String.valueOf(strIniTable.charAt(2))))==1){ Names[x] = "\u0421\u043e\u0431\u0441\u0442\u0432\u0435\u043d\u043e \u0438\u043c\u0435"; strQ=strQ + ", ls_main.first";x++;}
            if(Integer.parseInt((String.valueOf(strIniTable.charAt(3))))==1){ Names[x] = "\u041f\u0440\u0435\u0437\u0438\u043c\u0435"; strQ=strQ + ", ls_main.second";x++;}
            if(Integer.parseInt((String.valueOf(strIniTable.charAt(4))))==1){ Names[x] = "\u0424\u0430\u043c\u0438\u043b\u0438\u044f"; strQ=strQ + ", ls_main.family";x++;}
            if(Integer.parseInt((String.valueOf(strIniTable.charAt(5))))==1){ Names[x] = "\u0415\u0413\u041d"; strQ=strQ + ", ls_main.egn";x++;}
            if(Integer.parseInt((String.valueOf(strIniTable.charAt(6))))==1){ Names[x] = "\u0414\u0430\u0442\u0430 \u043d\u0430 \u0440\u0430\u0436\u0434\u0430\u043d\u0435"; strQ=strQ + ", DATE_FORMAT(ls_dates.b_date,'%d-%m-%Y') AS bdate";x++;}
            ...
            if(Integer.parseInt((String.valueOf(strIniTable.charAt(9)))) == 1){Names[x] ="\u0418\u0437\u0434\u0430\u0434\u0435\u043d\u0430 \u043d\u0430"; strQ=strQ + ", DATE_FORMAT(ls_dates.data_izd_LK,'%d-%m-%Y') AS date_lk";x++;}
            if(Integer.parseInt((String.valueOf(strIniTable.charAt(10))))==1){ Names[x] = "\u041e\u0431\u043b\u0430\u0441\u0442"; strQ=strQ + ", n_oblast.name AS name_oblast";x++;}
            ...
            if(Integer.parseInt((String.valueOf(strIniTable.charAt(18))))==1){ Names[x] = "\u0414\u0430\u0442\u0430 \u043d\u0430 \u043d\u0430\u0437\u043d\u0430\u0447\u0430\u0432\u0430\u043d\u0435"; strQ=strQ + ", DATE_FORMAT(ls_dates.data_naznach,'%d-%m-%Y') AS nazdate";x++;}
            if(Integer.parseInt((String.valueOf(strIniTable.charAt(19))))==1){ Names[x] = "\u0414\u0430\u0442\u0430 \u043d\u0430 \u043f\u043e\u0441\u0442\u044a\u043f\u0432\u0430\u043d\u0435"; strQ=strQ + ", DATE_FORMAT(ls_dates.data_postypwane,'%d-%m-%Y') AS postdate";x++;}
            if(Integer.parseInt((String.valueOf(strIniTable.charAt(20))))==1){ Names[x] = "\u0414\u0430\u0442\u0430 \u043d\u0430 \u043d\u0430\u043f\u0443\u0441\u043a\u0430\u043d\u0435"; strQ=strQ + ", DATE_FORMAT(ls_dates.data_napuskane,'%d-%m-%Y') AS napudate";x++;}
            if(Integer.parseInt((String.valueOf(strIniTable.charAt(21))))==1){ Names[x] = "\u041f\u043e\u0441\u043b\u0435\u0434\u0435\u043d \u0434\u0435\u043d \u0432 \u043e\u0441\u0438\u0433\u0443\u0440\u044f\u0432\u0430\u043d\u0435"; strQ=strQ + ", DATE_FORMAT(ls_dates.posl_den_w_osig,'%d-%m-%Y') AS posddate";x++;}
            if(Integer.parseInt((String.valueOf(strIniTable.charAt(22))))==1){ Names[x] = "\u041e\u0441\u043d\u043e\u0432\u0430\u043d\u0438\u0435 \u043d\u0430 \u0434\u043e\u0433\u043e\u0432\u043e\u0440\u0430"; strQ=strQ + ", osnowanie_dog";x++;}
            if(Integer.parseInt((String.valueOf(strIniTable.charAt(23))))==1){ Names[x] = "\u0421\u0440\u043e\u043a \u043d\u0430 \u0414\u043e\u0433\u043e\u0432\u043e\u0440\u0430"; strQ=strQ + ", DATE_FORMAT(ls_dates.srok_dogov, '%d-%m-%Y') AS srok_dog ";x++;}
            ...
            strQ=strQ + " FROM ls_main LEFT JOIN ls_dates ON (ls_dates.id_rab = ls_main.id) LEFT JOIN ls_addresses ON (ls_addresses.id_rab = ls_main.id) LEFT JOIN n_nm ON (n_nm.id = ls_addresses.id_nasm) LEFT JOIN n_oblast ON (n_oblast.id = n_nm.id_oblast)";
