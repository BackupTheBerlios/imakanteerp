...
#   document lines
#
CREATE TABLE n_document_lines (
  id_dl INTEGER UNSIGNED NOT NULL AUTO_INCREMENT,
  id_df INTEGER UNSIGNED NOT NULL,
  id_pm INT(11) NOT NULL,
  id_n_storage INTEGER UNSIGNED NOT NULL,
  singly_price_dl DOUBLE NOT NULL,
  climb_down_dl DOUBLE NULL,
  numbers_piece_df INTEGER UNSIGNED NOT NULL,
  dds_dl DOUBLE NULL,
  totalall_dl DOUBLE NULL,
  PRIMARY KEY(id_dl)
)ENGINE=MyISAM DEFAULT CHARSET=cp1251;
...
CREATE TABLE n_document_facade (
  id_df INTEGER UNSIGNED NOT NULL AUTO_INCREMENT,
  number_df INTEGER(10) UNSIGNED NULL,
  type_df INTEGER UNSIGNED NULL,
  condition_df VARCHAR NULL,
  level_df INTEGER UNSIGNED NULL,
  in_contragent_df INT(11) NULL,
  in_object_df INTEGER NULL,
  out_store_df INTEGER UNSIGNED NULL,
  out_contragent_df INT(11) NULL,
  out_object_df INTEGER NULL,
  total_df DOUBLE NULL,
  dds_df DOUBLE NULL,
  user_df INTEGER UNSIGNED NULL,
  date_edition_df DATE NULL,
  time_edition_df TIME NULL,
  distributor_df INT(11) NULL,
  deliverer_df INT(11) NULL,
  faktura_conecion_df INTEGER UNSIGNED NULL,
  zaqvka_connection_df INTEGER UNSIGNED NULL,
  description_pay_df INTEGER UNSIGNED NULL,
  paying_order_df INTEGER UNSIGNED NULL,
  date_deliver_df DATE NULL,
  duty_df INTEGER UNSIGNED NULL,
  date_pay_df DATE NULL,
  user_last_edit_df INTEGER UNSIGNED NULL,
  comment_df VARCHAR NULL,
  flag_finish_doc_df TINYINT(3) UNSIGNED NULL DEFAULT 0,
  id_rep INTEGER UNSIGNED NULL,
  PRIMARY KEY(id_df)
)ENGINE=MyISAM DEFAULT CHARSET=cp1251;
...
CREATE TABLE `ls_n_person` (
  `id_ls_n_person` int(10) unsigned zerofill NOT NULL auto_increment,
...
CREATE TABLE `n_doc_type_user_rights` (
  ...
  `id_sdtn` int(11) unsigned default NULL,
  `rights_sdtn` int(3) unsigned default '0',
...
CREATE TABLE `n_incoms` (
  ...
  `id_n_group` int(11) unsigned default NULL,
  `cdode_n_incoms` int(11) unsigned default NULL,
