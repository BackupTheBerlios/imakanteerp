...
CREATE PROCEDURE sl_procedure_paying_orders(IN comprator TINYINT, IN in_id INT(11), IN in_id_spt INT(11), IN in_id_nbc INT(11), 
                                            ...
                                            IN in_amount DECIMAL(12,2), IN in_instant TIMESTAMP)
BEGIN
     IF (comprator = 0) THEN
     ...
     IF (comprator = 1) THEN
        INSERT INTO sl_paying_orders (id_spt, id_nbc, id_contragent, amount) 
                VALUES(in_id_spt, in_id_nbc, in_id_contragent, in_amount);
     END IF;
     ...
     IF (comprator = 8) THEN
        SELECT nc.id_contragent, nc.name_n_contragent, nc.code_contragent, nc.BANKNAMER, nc.IBANR, nc.VIDVALR, 
        nc.BANKNAMED, nc.IBAND, nc.VIDVALD 
