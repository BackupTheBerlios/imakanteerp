...
CREATE PROCEDURE nom_procedure_money (IN in_id INT(6), IN comprator INT(6), IN in_code INT(11), IN in_cod_lat VARCHAR(6), IN in_name VARCHAR(30), IN in_comments VARCHAR(255))
BEGIN        
     IF (comprator = 0) THEN
