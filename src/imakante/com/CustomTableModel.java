...
public class CustomTableModel extends AbstractTableModel implements Serializable
{
	...
	{ 
	    ...
	    {
		// mappings are based on Table 3 in JDBC/MySQL
		// Tutorial 1		
		...
		// There is no boolean datatype in MySQL
		case Types.BIT:
	...
	try
	{
	    ...
	    if (isUpdatable && rsMetaData.isWritable(column+1) && !rsMetaData.isAutoIncrement(column+1))
	    {
		return true;
	    }
