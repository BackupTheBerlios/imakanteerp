...
public class aeCodMit extends imakante.com.vcomponents.iDialog {
    
    public aeCodMit(imakante.com.vcomponents.iInternalFrame frame, boolean modal) {
        super(frame, modal);
        this.myParent = (nom.FrmCodMit) frame;
        initComponents();
        getNavigationState();
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(
                ...
                .add(org.jdesktop.layout.GroupLayout.LEADING, jPanel3, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 310, Short.MAX_VALUE)
    ...
    //--------------- My Variables
    private nom.FrmCodMit myParent;
    ...
    private void saveRecord() {
        ...
        try {
            myParent.setCode(jTextField1.getText());
        } catch (NumberFormatException nfex) { nfex.printStackTrace(); }
        myParent.setNames(jTextField3.getText());
        myParent.getInternalObject().updateRow(myParent.getId(), myParent.getCode(), myParent.getNames());
