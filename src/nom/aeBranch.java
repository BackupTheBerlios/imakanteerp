...
public class aeBranch extends iDialog{
    
    public aeBranch(imakante.com.vcomponents.iInternalFrame frame, boolean ismodal,int row, int id, int code, String name) {
        super(frame, ismodal);
        this.row = row;
        this.id = id;
        this.code = code;
