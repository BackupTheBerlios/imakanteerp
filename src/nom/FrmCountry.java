...
public class FrmCountry extends  imakante.com.vcomponents.iInternalFrame implements java.awt.event.WindowListener {
    ...
    private  nom.countries internalObject;
    ...
    private void constructObject() {
        try {
            internalObject = new nom.countries(conn);
        } catch(Exception e) { e.printStackTrace(); }
    }
    ...
    public nom.countries getInternalObject() {
        return internalObject;
    }
    
    public void setInternalObject(nom.countries val) {
