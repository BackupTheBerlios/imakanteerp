...
public class FrmCasa extends  imakante.com.vcomponents.iInternalFrame implements java.awt.event.WindowListener {
    
    public FrmCasa(String title,imakante.com.vcomponents.iFrame frame) {
        super(title);
        myframe = frame;
