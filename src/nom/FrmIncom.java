...
public class FrmIncom extends  imakante.com.vcomponents.iInternalFrame implements java.awt.event.WindowListener {
    
    public FrmIncom(String title,imakante.com.vcomponents.iFrame frame) {
        super(title);
        myframe = frame;
