...
public class FrmCodMit extends  imakante.com.vcomponents.iInternalFrame implements java.awt.event.WindowListener {
    
    public FrmCodMit(String title,imakante.com.vcomponents.iFrame frame) {
        super(title);
        myframe = frame;
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("\u041f\u0440\u043e\u0434\u0443\u043a\u0442\u0438 \u0438 \u041c\u0438\u0442\u043d\u0438\u0447\u0435\u0441\u043a\u0438 \u0422\u0430\u0440\u0438\u0444\u0438");
    ...
    private  nom.dbcodmit internalObject;
    ...
    private void constructObject() {
        try {
            internalObject = new nom.dbcodmit(conn);
        } catch(Exception e) { e.printStackTrace(); }
    }
    ...
    public nom.dbcodmit getInternalObject() {
        return internalObject;
    }
    
    public void setInternalObject(nom.dbcodmit val) {
    ...
    private void editRecord() {
        if (table.getSelectedRow() != -1) {
            ...
            setAllVariables();
            nom.aeCountry ae_Countries = new nom.aeCountry(this, true);
            ae_Countries.setVisible(true);
        } else {  }
    }
