...
public class storageDB  extends dbObject {
    //-------------START MyVariables
    private String splitNamesG[];
    private int indexConnOfId[] = null; // masiv prave6t vryzkata mejdu indexite na ComboBox_a i "ID" na tablicata za grupi storage
    ...
    private String name; // imena ot tablicata                                 > tablica "storage"
    private int id_groupe=0; // vryzkata kym tablicata za grope  /
    private String comment="";//                                                  /
    private Connection conn;
    //-------------END MyVariables
    
    /** Creates a new instance of storageDB */
    public storageDB(java.sql.Connection conn) {
        super(conn);
        prepareCstm();
    ...
    public void prepareCstm() // OK
    {
        try {
            ...
            setCstm(getConn().prepareCall("{call nom_procedure_storage(?,?,?,?,?,?)}"));
